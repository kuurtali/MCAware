...
write.csv(corr_all, file.path(OUTDIR_DIAG, "mcaware_nasdaq_CORR.csv"), row.names=FALSE)
...
write.csv(res_df, file.path(OUTDIR_SUM, "mcaware_nasdaq_RESULTS.csv"), row.names=FALSE)
...
write.csv(summary_df, file.path(OUTDIR_SUM, "mcaware_nasdaq_SUMMARY.csv"), row.names=FALSE)
