...
write.csv(all_df, file.path(OUTDIR, "mcaware_bist_multi_stock_RESULTS.csv"), row.names=FALSE)
...
write.csv(summary_df, file.path(OUTDIR, "mcaware_bist_multi_stock_SUMMARY.csv"), row.names=FALSE)
...
cat(sprintf("\nCSV: %s\n", file.path(OUTDIR, "mcaware_bist_multi_stock_SUMMARY.csv")))
