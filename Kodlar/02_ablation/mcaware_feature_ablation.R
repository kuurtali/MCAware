...
write.csv(results_df, file.path(OUTDIR_SUM, "mcaware_feature_ablation_RESULTS.csv"), row.names=FALSE)
...
write.csv(summary_df, file.path(OUTDIR_SUM, "mcaware_feature_ablation_SUMMARY.csv"), row.names=FALSE)
