...
write.csv(corr_df, file.path(OUTDIR, "mcaware_corr_analysis.csv"), row.names=FALSE)
...
write.csv(res_df, file.path(OUTDIR, "mcaware_single_feat_ablation_RESULTS.csv"), row.names=FALSE)
...
write.csv(summary_df, file.path(OUTDIR, "mcaware_single_feat_ablation_SUMMARY.csv"), row.names=FALSE)
