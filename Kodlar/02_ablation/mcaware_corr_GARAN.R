...
write.csv(garan_corr_df, file.path(OUTDIR, "mcaware_corr_GARAN.csv"), row.names=FALSE)
...
thyao_corr_file <- file.path(OUTDIR, "mcaware_corr_analysis.csv")
nasdaq_corr_file <- file.path(OUTDIR, "mcaware_nasdaq_CORR.csv")
...
write.csv(comparison_df, file.path(OUTDIR, "mcaware_corr_COMPARISON.csv"), row.names=FALSE)
