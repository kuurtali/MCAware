...
# CSV-as-constitution kuralı: ESKİ CSV'nin üzerine yazar (R script üzerinden)
################################################################################
...
# --- Paths (projenin mevcut yapısıyla uyumlu) ---
WORKDIR <- here::here()
...
summary_df <- all_df %>%
  ...
  summarise(
    ...
    dt_acc      = mean(dt_acc),
    # --- YENİ: 3 ayrı anti-prediktif kriter sütunu ---
...
# --- Ekrana bas ---
cat("\n=== YENİ SUMMARY (strict/ambiguous ayrımı) ===\n")
...
# --- STRICT CSV de üret (sigorta ile tutarlı) ---
