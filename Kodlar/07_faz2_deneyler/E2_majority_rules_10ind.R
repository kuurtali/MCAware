...
# 10 teknik gösterge ile majority-voting tabanlı klasik sinyal üretimi
################################################################################
...
# Oncelikle mevcut predictions CSV'den kapanış fiyatlarını çek
...
# NA'ları temizle (warm-up dönemi)
...
# --- Performans Hesapla ---
# Gerçek yön: t+1 kapanış > t kapanış
