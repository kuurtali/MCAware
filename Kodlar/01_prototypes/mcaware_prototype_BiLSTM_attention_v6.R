...
# --- 12. CSV cikti ---
out1 <- file.path(OUTDIR_PRED, "mcaware_BiLSTM_attn_v6_PREDICTIONS.csv")
out2 <- file.path(OUTDIR_THR, "mcaware_BiLSTM_attn_v6_THRESHOLD_GRID.csv")
out3 <- file.path(OUTDIR_SUM, "mcaware_BiLSTM_attn_v6_OPTIMAL.csv")
out4 <- file.path(OUTDIR_SUM, "mcaware_BiLSTM_attn_v6_SUMMARY.csv")
out5 <- file.path(OUTDIR_DIAG, "mcaware_BiLSTM_attn_v6_YHAT_STATS.csv")
