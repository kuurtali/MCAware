...
# --- 0. Ortam ayarlari ---
WORKDIR <- here::here()
# [B18] OUTDIR <- here::here()   # CSV'ler buraya
...
# CSV yaz
out1 <- file.path(OUTDIR_PRED, "mcaware_BiLSTM_v2a_PREDICTIONS.csv")
out2 <- file.path(OUTDIR_THR, "mcaware_BiLSTM_v2a_THRESHOLD_GRID.csv")
out3 <- file.path(OUTDIR_SUM, "mcaware_BiLSTM_v2a_OPTIMAL.csv")
out4 <- file.path(OUTDIR_SUM, "mcaware_BiLSTM_v2a_SUMMARY.csv")
