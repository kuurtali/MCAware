...
# CSV
out1 <- file.path(OUTDIR_PRED, "mcaware_BiLSTM_v3b_window_PREDICTIONS.csv")
out2 <- file.path(OUTDIR_THR, "mcaware_BiLSTM_v3b_window_THRESHOLD_GRID.csv")
out3 <- file.path(OUTDIR_SUM, "mcaware_BiLSTM_v3b_window_OPTIMAL.csv")
out4 <- file.path(OUTDIR_SUM, "mcaware_BiLSTM_v3b_window_SUMMARY.csv")
out5 <- file.path(OUTDIR_DIAG, "mcaware_BiLSTM_v3b_window_YHAT_STATS.csv")
