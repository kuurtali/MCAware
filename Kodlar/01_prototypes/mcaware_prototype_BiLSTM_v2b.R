...
# CSV
out1 <- file.path(OUTDIR, "mcaware_BiLSTM_v2b_PREDICTIONS.csv")
out2 <- file.path(OUTDIR, "mcaware_BiLSTM_v2b_THRESHOLD_GRID.csv")
out3 <- file.path(OUTDIR, "mcaware_BiLSTM_v2b_OPTIMAL.csv")
out4 <- file.path(OUTDIR, "mcaware_BiLSTM_v2b_SUMMARY.csv")
out5 <- file.path(OUTDIR, "mcaware_BiLSTM_v2b_YHAT_STATS.csv")
