...
# CSV
out1 <- file.path(OUTDIR, "mcaware_BiLSTM_v3b_GARAN_PREDICTIONS.csv")
out2 <- file.path(OUTDIR, "mcaware_BiLSTM_v3b_GARAN_THRESHOLD_GRID.csv")
out3 <- file.path(OUTDIR, "mcaware_BiLSTM_v3b_GARAN_OPTIMAL.csv")
out4 <- file.path(OUTDIR, "mcaware_BiLSTM_v3b_GARAN_SUMMARY.csv")
out5 <- file.path(OUTDIR, "mcaware_BiLSTM_v3b_GARAN_YHAT_STATS.csv")
