...
with tabs[11]:
    ...
    _gallery = {
        ...
        "📊 Yeni CSV Analizleri (10 Haziran 2026)": [
            ...
            ("51_WF_v2_FoldXMimari_Heatmap.png", "WF v2 Fold×Mimari", "7 fold × 7 mimari flip accuracy ısı haritası."),
            ...
            ("56_Threshold_MultiArch_Overlay.png", "Threshold Overlay", "7 mimari threshold eğrisi üst üste."),
